...
let destinationsData
  ...
  it('should find a destination by an ID', () => {
    ...
    expect(destinations.findDestination(1)).to.be.an('object')
    expect(destinations.findDestination(2)).to.be.an('object')
  })
  ...
  it('should have an ID for each destination', () => {
    ...
    expect(destinations.findDestination(1).id).to.be.a('number');
    expect(destinations.findDestination(2).id).to.be.a('number');
  });
  ...
  it('should have a city for each destination', () => {
    ...
    expect(destinations.findDestination(1).destination).to.be.a('string');
    expect(destinations.findDestination(1).destination).to.be.a('string');
  });
  ...
  it('should have an estimated cost for lodging for each destination', () => {
    ...
    expect(destinations.findDestination(1).estimatedLodgingCostPerDay).to.be.a('number');
    expect(destinations.findDestination(2).estimatedLodgingCostPerDay).to.be.a('number');
  });
  ...
  it('should have an estimated cost per person for flights for each destination', () => {
    ...
    expect(destinations.findDestination(1).estimatedFlightCostPerPerson).to.be.a('number');
    expect(destinations.findDestination(2).estimatedFlightCostPerPerson).to.be.a('number');
  });
  ...
  it('should have an image for each destination', () => {
    ...
    expect(destinations.findDestination(1).image).to.be.a('string');
    expect(destinations.findDestination(2).image).to.be.a('string');
  });
  ...
  it('should have alt text for each destination', () => {
    ...
    expect(destinations.findDestination(1).alt).to.be.a('string');
    expect(destinations.findDestination(2).alt).to.be.a('string');
  });
