...
let tripsData = sampleData.trips;
  ...
  it('should have an ID', () => {
    ...
    expect(trip2.id).to.be.a('number')
  });

  it('should have a traveler ID', () => {
    expect(trip1.travelerID).to.equal(1);
    expect(trip2.travelerID).to.equal(1);
    expect(trip1.travelerID).to.be.a('number')
    expect(trip2.travelerID).to.be.a('number')
  });
  ...
  it('should have a duration', () => {
    ...
    expect(trip2.duration).to.be.a('number')
  });
  ...
  it('should have a status', () => {
    ...
    expect(trip2.status).to.be.a('string')
  });
  ...
  it('should know the name of the destination', () => {
    ...
    expect(trip1.destinationName).to.be.a('string')
    expect(trip2.destinationName).to.be.a('string')
  });
  ...
  it('should know the daily lodging cost of the destination', () => {
    ...
    expect(trip1.dailyLodgingCost).to.be.a('number')
    expect(trip2.dailyLodgingCost).to.be.a('number')
  });
  ...
  it('should know the cost of a flight per person for the destination', () => {
    ...
    expect(trip1.flightCostPerTraveler).to.be.a('number')
    expect(trip2.flightCostPerTraveler).to.be.a('number')
  });
  ...
  it('should have an image of the destination', () => {
    ...
    expect(trip1.picture).to.be.a('string')
    expect(trip2.picture).to.be.a('string')
  });
  ...
  it('should have alt text for the image', () => {
    ...
    expect(trip1.altText).to.be.a('string')
    expect(trip2.altText).to.be.a('string')
  })
